...
public class SortTester {
	...
	private void runTests() {
		...
		if (PRINT_SECTION_SUMMARIES)
			printSectionSummary("Empty List");
	 ...
	 * @param listToSort
	 * @param sortedList
	 * @return true if listToSort and sortedList are the same after sorting
	 *         listToSort
	 */
	 ...
	 * @return true if they are the same size and contain all of the same elements
	 *         in the same order, else false
	 */
	...
	/**
	 * Prints out contents of two lists, labels list1 "current list" and list2
	 * "expected list"
	 * 
